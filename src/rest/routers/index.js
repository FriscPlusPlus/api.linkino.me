...
router.post(
  '/app',
  createLinkSpeedLimiter,
  createLinkRateLimiter,
  controllers.links.createLink
);
...
router.post(
  '/app/sendClip',
  sendClipSpeedLimiter,
  sendClipRateLimiter,
  controllers.contact.sendClip
);
router.post(
  '/app/contactUs',
  contactSpeedLimiter,
  contactRateLimiter,
  controllers.contact.contact_us
);
...
router.get(
  ...
  isLoggedIn,
  isExpired,
  controllers.clips.getAllClips
);
router.post(
  '/app/approveClip/:id',
  isLoggedIn,
  isExpired,
  controllers.clips.approveClip
);
router.post(
  '/app/declineClip/:id',
  isLoggedIn,
  isExpired,
  controllers.clips.declineClip
);
router.post(
  '/app/deleteClip/:id',
  isLoggedIn,
  isExpired,
  controllers.clips.deleteClip
);
